...
| Advanced data | Partial / battles, badges and cloud sync complete | Encrypted Cloudflare Worker/KV sync is configured; all 16 Johto/Kanto badges and 668 workbook trainer battles, including 229 VS Seeker rematches, are active; maps remain deferred |
